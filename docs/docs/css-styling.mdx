...
`reactjs-popup` provides a `className` prop, but you need to be careful using this class in your CSS as we add `-content` , `-overlay` and `-arrow`, which mean you need to add style for `className-popup`,`className-overlay`,`className-arrow`:
