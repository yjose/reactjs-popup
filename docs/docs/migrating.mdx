...
As you may now, v2 is a complete rewrite of reactjs-popup first version, and we built the new version very carefully to make sure everything should work as expected with the old component API.
...
For those couple of reasons, we through that maybe it would be more clean and practical to make those styles as an css file to make sure people can override them easily:
