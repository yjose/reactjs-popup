...
## Smart Toolip Position

For more accesiblity you should make sure your tooltip is visible ander body viewport, in such case you can set `position` as array of disared positions and set `keepTooltipInsde` to `true`
