...
(function (global, factory) {
  var define;  // Demo Test Stub for testing only this file in simple App.js
  ...
  function (_React$PureComponent) {
    ...
    function Popup(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "togglePopup", function (e) {
        ...
        e.persist();
        if (_this.state.isOpen) _this.closePopup(e);else {
           _this.openPopup(e);
           if (props.popupTimeout !== undefined) {
            setTimeout(function () { _this.closePopup(e) }, props.popupTimeout);
          };
        }
      });
