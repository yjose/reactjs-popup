  ...
  var Popup = /*#__PURE__*/function (_React$PureComponent) {
    ...
    function Popup(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "onEscape", function (e) {
        console.warn('BLUR EEE', e.key, _this.props.closeOnKeyboardBlur);

        if (_this.props.closeOnEscape && e.key === 'Escape' || _this.props.closeOnKeyboardBlur && e.key === 'Tab') {
          _this.closePopup();
        }
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "renderTrigger", function () {
        ...
        if (_this.props.closeOnKeyboardBlur) {
          console.warn('aga'); // triggerProps.onBlur = this.onEscape;
        }
    ...
    _createClass(Popup, [{
      ...
      value: function componentDidMount() {
        var _this$props6 = this.props,
            ...
            closeOnKeyboardBlur = _this$props6.closeOnKeyboardBlur;
      ...
      value: function componentWillUnmount() {
        ...
        var _this$props8 = this.props,
            ...
            closeOnKeyboardBlur = _this$props8.closeOnKeyboardBlur; // remove events listeners
