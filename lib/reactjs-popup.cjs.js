...
function calculatePosition(triggerBounding, ContentBounding, position, arrow, _ref2, wrapperBounding) {
  ...
  function Popup(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setPosition", function () {
      var _this$props = _this.props,
          ...
          getTooltipBoundary = _this$props.getTooltipBoundary;
      ...
      var tooltipBoundary = getTooltipBoundary();
      var boundingBox = tooltipBoundary && typeof tooltipBoundary.getBoundingClientRect === "function" ? tooltipBoundary.getBoundingClientRect() : null;
...
_defineProperty(Popup, "defaultProps", {
  ...
  mouseEnterDelay: 100,
  mouseLeaveDelay: 100,
  getTooltipBoundary: function getTooltipBoundary() {}
});
...
if (process.env.NODE_ENV !== "production") {
  ...
  var POSITION_TYPES = ["top left", "top center", "top right", "bottom left", "bottom center", "bottom right", "right top", "right center", "right bottom", "left top", "left center", "left bottom"];
  Popup.propTypes = {
